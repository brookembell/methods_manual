...
# debug
z="age_female_race_outcome_pathway"

health_results <- function(z){
  
  my_list <- list()
  
  for (i in cra_folder_name) {
    
    x <- read_csv(paste0("out/", output_folder_name ,"/CRA/", i, "/summarystats_attributable_USmortality_by_", z, "_2015_US.csv"))
