...
# create vectors
output_folder_name <- "output_060724_1000sims"
cra_folder_name <- dir(paste0("out/Model results/", output_folder_name, "/CRA"))
costenv_folder_name <- dir(paste0("out/Model results/", output_folder_name, "/cost_env"))
...
for (i in cra_folder_name) {
  ...
  x <- read_csv(paste0("out/Model results/", 
                       output_folder_name ,
                       "/CRA/", 
                       i, 
...
cancer <- read_csv("in/FINAL/raw_data/cancer_incidence_060424_FINAL.csv")
cvd <- read_csv("in/FINAL/raw_data/cvd_mortality_060424_FINAL.csv")
...
# export
write_csv(comb_new, paste0("tables_figures/manuscript/data/abs_change_10perc_tableau_long_", export_date, ".csv"))
