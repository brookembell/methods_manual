...
This chapter walks you through all of the R code used to clean the raw **COST**-related data inputs. The resulting cleaned dataset is then used to calculate the cost impact factors (see [Chapter 6.2](calculate-cost-environment-and-social-impact-factors.html#cost-impact-factors)).
