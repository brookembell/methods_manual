...
A Github repository (AKA repo) titled [methods-manual](https://github.com/brookembell/methods-manual) has been created to store all of the project's code, data, and documentation (including this manual). In order to gain access to the Github repo, you must ask Brooke to add you as a user.
