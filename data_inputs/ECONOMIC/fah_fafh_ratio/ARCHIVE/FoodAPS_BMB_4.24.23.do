...
* 6) eggs
replace foodcode=6 if substr(foodcode1,1,1)=="3" & codenot1112==0
...
* 10) grains (total)
replace foodcode=10 if substr(foodcode1,1,1)=="5" & codenot1112==0

* 11) fruit excluding juice
replace foodcode=11 if (substr(foodcode1,1,2)=="61" | substr(foodcode1,1,2)=="62" | substr(foodcode1,1,2)=="63") & codenot1112==0

* 12) fruit juice
replace foodcode=12 if substr(foodcode1,1,2)=="64" & codenot1112==0
...
putexcel set "/Users/bmb73/Library/CloudStorage/Box-Box/lasting_aim_3/planning/Methods of estimating FAFH to FAH ratio/Brooke/Results/Results_bmb_updated", sheet ("Byfood_amt_away_fap") modify
putexcel A1=("food") B1=("n") C1=("mean") D1=("se") E1=("lb") F1=("ub")
...
putexcel set "/Users/bmb73/Library/CloudStorage/Box-Box/lasting_aim_3/planning/Methods of estimating FAFH to FAH ratio/Brooke/Results/Results_bmb_updated", sheet ("Byfood_amt_home_fap") modify
putexcel A1=("food") B1=("n") C1=("mean") D1=("se") E1=("lb") F1=("ub")
