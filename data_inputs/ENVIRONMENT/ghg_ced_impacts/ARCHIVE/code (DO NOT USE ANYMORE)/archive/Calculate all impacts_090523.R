...
# join
# price_impact_wide1 <- left_join(price_impact_wide, subgroup_dat, by = c("seqn" = "SEQN"))
...
# cost_dat <- clean_func(x = allfoods_cost_bysub, y = "cost")
...
final_final_dat <- full_join(cost_dat, final_dat)
