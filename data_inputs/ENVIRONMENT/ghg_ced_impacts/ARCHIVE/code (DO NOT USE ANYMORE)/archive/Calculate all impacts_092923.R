...
my_enviro_table <- 
  both_days24 %>% 
  mutate(
    GHG_consumed = (GHG_mn / 1000) * consumed_amt_FCID,
    GHG_inedible = (GHG_mn / 1000) * inedible_amt_FCID,
    GHG_wasted = (GHG_mn / 1000) * wasted_amt_FCID,
    
    CED_consumed = (CED_mn / 1000) * consumed_amt_FCID,
    CED_inedible = (CED_mn / 1000) * inedible_amt_FCID,
    CED_wasted = (CED_mn / 1000) * wasted_amt_FCID)
