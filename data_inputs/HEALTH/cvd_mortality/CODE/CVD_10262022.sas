...
data AA2018HIS; set CVD.AA2018HIS ;  where hispanic_origin_code <>. ;RACE="HIS" ;
...
data AA2018NONHIS; set CVD.AA2018NONHIS ;  where hispanic_origin_code <>. ;
...
data AA2018OTH; set CVD.AA2018OTH ;  where hispanic_origin_code <>. ;RACE="OTHER" ;
KEEP  Ten_year_age_groups gender hispanic_origin RACE deaths population Crude_rate Crude_rate_STANDARD_ERROR ; 
run; 
