...
*run sas file CVD_0410203 first*
...
data IHD2018NONHIS20; set CVD.IHD2018NONHIS20 ;  where Race_Code <>. ;
if race="White" then race="NHW" ;
else race="NHB" ;
KEEP   gender hispanic_origin race deaths population Crude_rate Crude_rate_STANDARD_ERROR; 
run; 
...
data PVD2018PVD20; set CVD.PVD2018OTH20 ;  where hispanic_origin_code <>. ;RACE="OTH" ;
KEEP   gender hispanic_origin RACE deaths population Crude_rate Crude_rate_STANDARD_ERROR ; 
run; 
