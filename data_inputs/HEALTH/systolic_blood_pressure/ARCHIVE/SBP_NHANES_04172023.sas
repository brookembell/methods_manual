libname RAW "C:\Users\zgu02\Box\lasting_aim_3\model development\data_new\in\SBP\RAW";
libname SBP "C:\Users\zgu02\Box\lasting_aim_3\model development\data_new\in\SBP\DATA";
*****************************************************************************************************************;
...
data hyper1718adult;set hyper1718;where subgroup_id <>.;
run;
...
data HBPrate1718;set B;
where Hyper_old=1;drop Table _SkipLine F_Hyper_old;
run;
