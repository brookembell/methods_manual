...
Import the NHANES individual-level food data (cleaned in [Section 2.2](#clean-raw-nhanes-data)), and merge with the FPED and WWEIA datasets.
...
See the [Section Code](#code) for information on how to gain access to OnDemand, and how to get a GitHub access token.
