...
# test
join1 %>% filter(outcome == "OSTK" & risk_factor == "fruit_tot") %>% View() # looks good
...
# test
join2 %>% filter(outcome == "CC" & risk_factor == "dairy_tot") %>% View() #good
join2 %>% filter(outcome == "CC" & risk_factor == "dairy_cow") %>% View() #good
join2 %>% filter(outcome == "CC" & risk_factor == "dairy_soy") %>% View() #good
join2 %>% filter(outcome == "MLPC" & risk_factor == "fruit_tot") %>% View() #good
...
# test
day_func(x=rr, y="pf_redm", u="g/day") %>% filter(risk_factor=="pf_redm" & logRR != 0) %>% View()
...
# check
rr1 %>% filter(risk_factor=="pf_seafood" & logRR != 0) %>% View() #good
rr1 %>% filter(risk_factor=="pf_redm_tot" & logRR != 0) %>% View() #good
...
# test
rr1 %>% convert_func(y="pf_poultry") %>% filter(risk_factor=="pf_poultry") %>% View()
rr1 %>% convert_func(y="dairy") %>% filter(risk_factor=="dairy") %>% View()
rr1 %>% convert_func(y="fruit_juice") %>% filter(risk_factor=="fruit_juice") %>% View()
...
# check
rr2 %>% filter(risk_factor=="leg_tot" & RR_converted !=0) %>% View()
rr2 %>% filter(risk_factor=="sodium") %>% View()
rr2 %>% filter(risk_factor=="water") %>% View()
...
# check
rr3 %>% filter(risk_factor=="sea_omega3_fa" & RR_converted !=0) %>% View()
rr3 %>% filter(risk_factor=="fiber" & RR_converted !=0) %>% View()
...
# check
rr4 %>% filter(risk_factor=="ssb" & RR_converted !=0) %>% View()
rr4 %>% filter(risk_factor=="pf_ns" & RR_converted !=0) %>% View()
...
# first, look at data
nhanes.dat1 %>% filter(diet == "ssb") %>% View() #this is fine
nhanes.dat1 %>% filter(diet == "sea_omega3_fa") %>% View()
...
# look at data
# nhanes.dat2 %>% filter(diet == "ssb") %>% View()
nhanes.dat2 %>% filter(diet == "sea_omega3_fa") %>% View()
...
dat1 %>% filter(diet == "pf_seafood") %>% select(subgroup, diet, diet_pattern, CF_mean_intake) %>% View()
#looks good
...
# check data
merged1 %>% select(subgroup, overweight_rate) %>% View()
...
This script transforms the NHANES dataset to match the structure of hte cost/environment mega dataset.
...
nhanes1 %>% filter(Foodgroup == "ssb") %>% View()
