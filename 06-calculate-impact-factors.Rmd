...
## Cost Impact Factors {#sec:cost-impact-factors}
...
Then, subset the dataset to only include participants who are eligible to be in the sample (i.e., inAnalysis == 1). [Chapter 2.2](cleaning-code-for-nhanes-diet-data.html#step-7-examine-cleaned-nhanes-data) explains more about these weight and inAnalysis variables.
