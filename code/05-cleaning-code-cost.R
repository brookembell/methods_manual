...
#' 
#' This chapter walks you through all of the R code used to clean the raw **COST**-related data inputs. The resulting cleaned dataset is then used to calculate the cost impact factors (see Chapter \@ref(cost-impact-factors)).
#' 
...
#' 
#' #### Mappings from Dietary Factor to FNDDS Food Code {.unnumbered}
#' 
#' There are two mappings from dietary factor to FNDDS Food Code. There is one specifically just for whole and refined grains - see Chapter \@ref(mapping-from-food-group-to-fndds-code) on how the whole vs. refined grains designation was determined. And the second one is for all other non-grain foods.
#' 
...
#' 
#' #### Food-At-Home (FAH) to Food-Away-Fram-Home (FAFH) Ratios {.unnumbered}
#' 
